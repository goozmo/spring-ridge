...
if (!function_exists('the_subtitle')):
    ...
    function eps_set_subtitle($post_id)
    {
        ...
        update_post_meta($post_id, SCP_PLUGIN_NAME . 'eps_subtitle', strip_tags(trim($_POST['eps_subtitle'])));
    }
    ...
    function the_subtitle($pid = null)
    {
        ...
        $metaData = get_post_meta($postId, SCP_PLUGIN_NAME . 'eps_subtitle', true);
    ...
    function eps_admin_css()
    {
        ...
        wp_enqueue_style('eps_style', SCP_PLUGIN_URL . '/extensions/easy-post-subtitle/include/style.css');
    }
    ...
    function eps_admin_scripts()
    {
        ...
        wp_enqueue_script('eps_scripts', SCP_PLUGIN_URL . '/extensions/easy-post-subtitle/include/scripts.js');
    }
